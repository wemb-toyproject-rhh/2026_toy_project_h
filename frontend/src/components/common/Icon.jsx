const ICONS = {
  ...
  help: (
    <>
      <circle cx="8" cy="8" r="6.8" fill="none" stroke="currentColor" strokeWidth="1.3" />
      <circle cx="8" cy="4.9" r="0.95" fill="currentColor" />
      <path d="M8 7.4v4.6" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
    </>
  ),
  settings: (
    <>
  ...
  note: (
    <>
      <rect
        ...
        strokeWidth="1.2"
      />
      <path d="M5.5 5.8h5M5.5 8.2h5M5.5 10.6h3" stroke="currentColor" strokeWidth="1.1" strokeLinecap="round" />
    </>
  ),
  comment: (
    <path
